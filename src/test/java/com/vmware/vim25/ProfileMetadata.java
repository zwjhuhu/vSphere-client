 ...
 *         &lt;element name="operationMessages" type="{urn:vim25}ProfileMetadataProfileOperationMessage" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends DynamicData
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the operationMessages property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<ProfileMetadataProfileOperationMessage> getOperationMessages() {
        if (operationMessages == null) {
            operationMessages = new ArrayList<ProfileMetadataProfileOperationMessage>();
        }
