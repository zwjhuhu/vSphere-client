...
/**
 * <p>Java class for ArrayOfVStorageObjectAssociations complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="VStorageObjectAssociations" type="{urn:vim25}VStorageObjectAssociations" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfVStorageObjectAssociations {
     ...
     * This is why there is not a <CODE>set</CODE> method for the vStorageObjectAssociations property.
     * 
     * <p>
    ...
    public List<VStorageObjectAssociations> getVStorageObjectAssociations() {
        if (vStorageObjectAssociations == null) {
            vStorageObjectAssociations = new ArrayList<VStorageObjectAssociations>();
        }
