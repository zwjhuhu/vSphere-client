 ...
 *         &lt;element name="warnings" type="{urn:vim25}ProfileUpdateFailedUpdateFailure" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends VimFault
{
    ...
    public List<ProfileUpdateFailedUpdateFailure> getWarnings() {
        if (warnings == null) {
            warnings = new ArrayList<ProfileUpdateFailedUpdateFailure>();
        }
