 ...
 *         &lt;element name="virtualDiskRules" type="{urn:vim25}VirtualDiskRuleSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends DynamicData
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the virtualDiskRules property.
     * 
     * <p>
    ...
    public List<VirtualDiskRuleSpec> getVirtualDiskRules() {
        if (virtualDiskRules == null) {
            virtualDiskRules = new ArrayList<VirtualDiskRuleSpec>();
        }
