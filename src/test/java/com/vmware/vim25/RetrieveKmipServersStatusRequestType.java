...
/**
 * <p>Java class for RetrieveKmipServersStatusRequestType complex type.
 * 
 ...
 *         &lt;element name="clusters" type="{urn:vim25}KmipClusterInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class RetrieveKmipServersStatusRequestType {
    ...
    public List<KmipClusterInfo> getClusters() {
        if (clusters == null) {
            clusters = new ArrayList<KmipClusterInfo>();
        }
