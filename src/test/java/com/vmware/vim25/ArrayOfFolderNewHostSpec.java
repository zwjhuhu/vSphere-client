...
/**
 * <p>Java class for ArrayOfFolderNewHostSpec complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="FolderNewHostSpec" type="{urn:vim25}FolderNewHostSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfFolderNewHostSpec {
     ...
     * This is why there is not a <CODE>set</CODE> method for the folderNewHostSpec property.
     * 
     * <p>
    ...
    public List<FolderNewHostSpec> getFolderNewHostSpec() {
        if (folderNewHostSpec == null) {
            folderNewHostSpec = new ArrayList<FolderNewHostSpec>();
        }
