...
/**
 * <p>Java class for ArrayOfClusterComputeResourceDVSSetting complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="ClusterComputeResourceDVSSetting" type="{urn:vim25}ClusterComputeResourceDVSSetting" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfClusterComputeResourceDVSSetting {
     ...
     * This is why there is not a <CODE>set</CODE> method for the clusterComputeResourceDVSSetting property.
     * 
     * <p>
    ...
    public List<ClusterComputeResourceDVSSetting> getClusterComputeResourceDVSSetting() {
        if (clusterComputeResourceDVSSetting == null) {
            clusterComputeResourceDVSSetting = new ArrayList<ClusterComputeResourceDVSSetting>();
        }
