...
/**
 * <p>Java class for ArrayOfFaultsByVM complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="FaultsByVM" type="{urn:vim25}FaultsByVM" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfFaultsByVM {
    ...
    public List<FaultsByVM> getFaultsByVM() {
        if (faultsByVM == null) {
            faultsByVM = new ArrayList<FaultsByVM>();
        }
