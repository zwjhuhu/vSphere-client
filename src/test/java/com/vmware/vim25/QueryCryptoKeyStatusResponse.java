 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}CryptoManagerKmipCryptoKeyStatus" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class QueryCryptoKeyStatusResponse {
    ...
    public List<CryptoManagerKmipCryptoKeyStatus> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<CryptoManagerKmipCryptoKeyStatus>();
        }
