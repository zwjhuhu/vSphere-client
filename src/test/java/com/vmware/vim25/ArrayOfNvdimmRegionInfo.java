...
/**
 * <p>Java class for ArrayOfNvdimmRegionInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="NvdimmRegionInfo" type="{urn:vim25}NvdimmRegionInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfNvdimmRegionInfo {
     ...
     * This is why there is not a <CODE>set</CODE> method for the nvdimmRegionInfo property.
     * 
     * <p>
    ...
    public List<NvdimmRegionInfo> getNvdimmRegionInfo() {
        if (nvdimmRegionInfo == null) {
            nvdimmRegionInfo = new ArrayList<NvdimmRegionInfo>();
        }
