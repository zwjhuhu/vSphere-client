 ...
 *         &lt;element name="propertyRelations" type="{urn:vim25}VirtualMachinePropertyRelation" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends DynamicData
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the propertyRelations property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<VirtualMachinePropertyRelation> getPropertyRelations() {
        if (propertyRelations == null) {
            propertyRelations = new ArrayList<VirtualMachinePropertyRelation>();
        }
