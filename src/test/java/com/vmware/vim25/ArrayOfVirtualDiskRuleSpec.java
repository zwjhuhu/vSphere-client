...
/**
 * <p>Java class for ArrayOfVirtualDiskRuleSpec complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="VirtualDiskRuleSpec" type="{urn:vim25}VirtualDiskRuleSpec" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfVirtualDiskRuleSpec {
     ...
     * This is why there is not a <CODE>set</CODE> method for the virtualDiskRuleSpec property.
     * 
     * <p>
    ...
    public List<VirtualDiskRuleSpec> getVirtualDiskRuleSpec() {
        if (virtualDiskRuleSpec == null) {
            virtualDiskRuleSpec = new ArrayList<VirtualDiskRuleSpec>();
        }
