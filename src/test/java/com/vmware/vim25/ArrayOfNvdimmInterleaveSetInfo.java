...
/**
 * <p>Java class for ArrayOfNvdimmInterleaveSetInfo complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="NvdimmInterleaveSetInfo" type="{urn:vim25}NvdimmInterleaveSetInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfNvdimmInterleaveSetInfo {
     ...
     * This is why there is not a <CODE>set</CODE> method for the nvdimmInterleaveSetInfo property.
     * 
     * <p>
    ...
    public List<NvdimmInterleaveSetInfo> getNvdimmInterleaveSetInfo() {
        if (nvdimmInterleaveSetInfo == null) {
            nvdimmInterleaveSetInfo = new ArrayList<NvdimmInterleaveSetInfo>();
        }
