...
/**
 * <p>Java class for HttpNfcLeaseSetManifestChecksumTypeRequestType complex type.
 * 
 ...
 *         &lt;element name="deviceUrlsToChecksumTypes" type="{urn:vim25}KeyValue" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class HttpNfcLeaseSetManifestChecksumTypeRequestType {
     ...
     * This is why there is not a <CODE>set</CODE> method for the deviceUrlsToChecksumTypes property.
     * 
     * <p>
    ...
    public List<KeyValue> getDeviceUrlsToChecksumTypes() {
        if (deviceUrlsToChecksumTypes == null) {
            deviceUrlsToChecksumTypes = new ArrayList<KeyValue>();
        }
