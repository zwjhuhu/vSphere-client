 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}ClusterComputeResourceValidationResultBase" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ValidateHCIConfigurationResponse {
    ...
    public List<ClusterComputeResourceValidationResultBase> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<ClusterComputeResourceValidationResultBase>();
        }
