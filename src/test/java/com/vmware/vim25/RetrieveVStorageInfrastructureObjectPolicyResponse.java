 ...
 *       &lt;sequence>
 *         &lt;element name="returnval" type="{urn:vim25}vslmInfrastructureObjectPolicy" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class RetrieveVStorageInfrastructureObjectPolicyResponse {
    ...
    public List<VslmInfrastructureObjectPolicy> getReturnval() {
        if (returnval == null) {
            returnval = new ArrayList<VslmInfrastructureObjectPolicy>();
        }
